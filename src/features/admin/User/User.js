...
export default function User() {
	...
	return (
		<div id="admin">
			<Modal title="Cấp quyền cho người dùng" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
			...
			<div className="content">
				{loading ? (
					...
					<div>
						...
						/>
						<Pagination defaultCurrent={page} onChange={onChangePage} total={user.count} />
					</div>
				)}
			</div>
		</div>
